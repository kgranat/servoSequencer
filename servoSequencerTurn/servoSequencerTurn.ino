...
{656,2400,1124,1828,1009,1928,2019d},
...
//turn left
int sequencesSpeeds[NUM_SEQEUENCES]  = {deltaTime, (deltaTime), deltaTime, deltaTime, 5 * deltaTime , deltaTime, deltaTime, deltaTime,     deltaTime, deltaTime, deltaTime/2};
