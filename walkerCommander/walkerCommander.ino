...
const int deltaTime = 250;
const int deltaTimeTurn = 1000;

const int turnSpeeds[NUM_SEQEUENCES]  = {deltaTime, (deltaTime), deltaTime, deltaTime, 5 * deltaTime , deltaTime, deltaTime};
